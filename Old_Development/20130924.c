...
task main()
{
  while(true)                            // Infinite loop:
  {
    ...
    if(joy2Btn(5))          // If Button 5 on controller 2 is pressed:
    {
      servo[Left_Flipper] = 40;      // Raise Servo 1 to position 200.
    }

    if(joy2Btn(6))          // If Button 6 on controller 2 is pressed:
    {
