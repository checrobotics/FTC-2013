...
task main()
{
  while(true)                            // Infinite loop:
  {
    ...
    {
      servo[Left_Flipper] = 0;      // Lower left flipper to position 255.
    }

    if(joy1Btn(5))          // If Button 7 on controller 1 is pressed:
    {
      servo[Left_Flipper] = 212.5;       // Raise left flipper to open 150 degrees.
    }
  ...
  if(joy1Btn(6))          // If Button  6 on controller 1 is pressed:
    ...
    {
      servo[Right_Flipper] = 255;       // Lower rigth flipper to position 0.
	  }
